...
const UserLogin = (props) => {
    ...
    const goTOQuiz = () => {
        isFormValid ? props.navigation.navigate('Category') : showQuizToast();
    }
    ...
    return (
        <View>
            {isfirstnamevalid === 0 && islastnamevalid === 0 && isnicknamevalid === 0 && isagevalid == 0 ?
                ...
                <ScrollView>
                    <View style={styles.form}>
                        <View style={styles.formControl}>
                            ...
                            <TextInput style={styles.input}  onChangeText={text => { setFirstName(text); setIsFirstNameValid(0) }} />
                            {isfirstnamevalid === 2 ? <Text style={styles.validateMessage}>Please enter your Firstname</Text> : <Text></Text>}
                        </View>
                        <View style={styles.formControl}>
                            <Text style={styles.label}>Lastname</Text>
                            <TextInput style={styles.input}  onChangeText={text => { setLastName(text); setIsLastNameValid(0) }} />
                            {islastnamevalid === 2 ? <Text style={styles.validateMessage}>Please enter your Lastname</Text> : <Text></Text>}
                        </View>
                        <View style={styles.formControl}>
                            <Text style={styles.label}>Nickname</Text>
                            <TextInput style={styles.input} onChangeText={text => { setNickName(text); setIsNickNameValid(0) }} />
                            {isnicknamevalid === 2 ? <Text style={styles.validateMessage}>Please enter your Nickname</Text> : <Text></Text>}
                        </View>
                        <View style={styles.formControl}>
                            <Text style={styles.label}>Age</Text>
                            <TextInput style={styles.input}  onChangeText={text => { setAge(text); setIsAgeValid(0) }} keyboardType="numeric" />
